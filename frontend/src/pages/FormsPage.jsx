...
/** Публичный просмотр раздела «Бланки». Редактирование — только в админ-панели. */
function FormsPage({ onOpenDocument }) {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetch(backendUrl(`/api/v1/forms/list?path=${encodeURIComponent(path)}`))
  ...
  return (
    <div className="smk-page">
      ...
      <h1 className="smk-page__title">Бланки</h1>
