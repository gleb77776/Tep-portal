...
/** Публичный просмотр документов раздела «Охрана труда, ГО и ЧС». Редактирование — только в админ-панели. */
function OhsPage({ onOpenDocument }) {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetch(backendUrl(`/api/v1/ot/list?path=${encodeURIComponent(path)}`))
  ...
  return (
    <div className="smk-page">
      ...
      <h1 className="smk-page__title">Охрана труда, гражданская оборона и чрезвычайные ситуации</h1>
